...
const router_artifacts = hre.artifacts.readArtifact("Router");
const dai_artifacts = hre.artifacts.readArtifact("Dai");
const weth_artifacts = hre.artifacts.readArtifact("Weth");
...
const amountIn = ethers.utils.parseUnits('0.1', 'wei');
